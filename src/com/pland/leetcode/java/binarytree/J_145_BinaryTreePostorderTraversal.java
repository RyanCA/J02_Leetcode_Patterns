...
public class J_145_BinaryTreePostorderTraversal {
	...
	public static void main(String args[]){
		...
		J_145_BinaryTreePostorderTraversal test = new J_145_BinaryTreePostorderTraversal();
		ArrayList<Integer> list = (ArrayList<Integer>)test.postOrderTraversal(root);
		for(Integer item :list){
			System.out.println("item="+item); //Expected Result: 2->3->5->6->4->7
		}
	...
	public ArrayList<Integer> postOrderTraversal(TreeNode node){
		...
		list = postOrderTraversal(node, list);
		return list;

	}
	
	private ArrayList<Integer> postOrderTraversal(TreeNode node, ArrayList<Integer> list){
